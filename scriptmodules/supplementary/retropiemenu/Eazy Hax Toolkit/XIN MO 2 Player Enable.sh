...
sudo cp /home/$user/RetroPie/retropiemenu/EAZYHAX/cmdline.txt.org /boot/cmdline.txt
sleep 10
exit
else
echo "Making the needed changes so your Xin Mo controller will show up as two controllers."
sleep 5
sudo cp /home/$user/RetroPie/retropiemenu/EAZYHAX/cmdline.txt.xin /boot/cmdline.txt
