...
runuser -l pi -c 'cd /home/pi/addonusb/piroms/roms/dreamcast; wget http://eazyhax.com/downloads/dreamcast.tar && tar -xvf dreamcast.tar && sleep 3 ;rm dreamcast.tar; sleep 1; mv dc_* /home/pi/MasOS/BIOS/; ln -sv fileThatDoesNotExist ~/MasOS/roms/dreamcast/systemManager.cdi'
runuser -l pi -c 'cd /home/pi/addonusb/piroms/roms/dreamcast; mv vmu_save* /opt/masos/configs/dreamcast'
...
runuser -l pi -c 'cd /home/pi/MasOS/roms/dreamcast; wget http://192.168.1.4/downloads/dreamcast.tar && tar -xvf dreamcast.tar && sleep 3 ;rm dreamcast.tar; sleep 1; mv dc_* /home/pi/MasOS/BIOS/; ln -sv fileThatDoesNotExist ~/MasOS/roms/dreamcast/systemManager.cdi'
runuser -l pi -c 'cd /home/pi/MasOS/roms/dreamcast; mv vmu_save* /opt/masos/configs/dreamcast'
