...
sudo mount -a
mkdir $usb_path/roms/
find "/home/pi/MasOS/roms" -mindepth 1 -maxdepth 1 -type d -printf "$usb_path/roms/%f\n" | xargs mkdir -p 2>/dev/null || true
sleep 1
sudo runuser -l pi -c 'mv /home/pi/MasOS/roms /home/pi/MasOS/localroms/'
sudo runuser -l pi -c 'mkdir /home/pi/MasOS/roms'
