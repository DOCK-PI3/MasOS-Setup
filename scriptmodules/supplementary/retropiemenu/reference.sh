...
function main_menu() {
    ...
    while true; do
        choice=$(dialog --backtitle "$BACKTITLE" --title " MAIN MENU " \
            ...
            2 "Attract Mode" \
            3 "RetroArch" \
            4 "Emulator and ROM information" \
            2>&1 > /dev/tty)
...
infobox="${infobox}___________________________________________________________________________\n\n"
infobox="${infobox}\n"
infobox="${infobox}Attract Mode Common Assignments\n\n"
infobox="${infobox}TAB           menu\n"
infobox="${infobox}A BUTTON      select\n"
infobox="${infobox}B BUTTON      back\n"
infobox="${infobox}\n"
infobox="${infobox}By default, the keyboard and player one gamepad are configured.\n"
infobox="${infobox}Pressing TAB > CONTROLS you can easily re-configure your controller for AM GUI controls.\n\n"
infobox="${infobox}Explore the various control settings, there are many additional controls available"
infobox="${infobox} such as deleting games, etc.\n"
infobox="${infobox}\n"
infobox="${infobox}By default, only two displays are shown.  You will need to manualy show any that you wish to see.\n"
infobox="${infobox}Run the Displays Utility located in the Attract Mode's RetroPie menu to enable them.\n"
infobox="${infobox}The Displays Utility will also allow you to switch from a traditional main menu to a nested main menu.\n"
infobox="${infobox}\n"
infobox="${infobox}If you want to manually change a display's theme (layout):\n"
infobox="${infobox}Press TAB > DISPLAYS > (choose display) > LAYOUT\n"
infobox="${infobox}Once there, you can change that particular display's theme (layout).\n"
infobox="${infobox}\n"
infobox="${infobox}Themes are named for their intended purpose.\n"
infobox="${infobox}Any theme name ending in \"main\" or \"menu\" are intended for the main menu or the nested category menus.\n"
infobox="${infobox}Any theme name ending in \"system\" is intended for the individual system displays.\n"
infobox="${infobox}\n"

dialog --backtitle "Attract Mode Information" \
--title "Emulation Station Information" \
...
infobox="${infobox}SELECT+LEFT            input state slot descrease\n"
infobox="${infobox}\n"
...
dialog --infobox "...processing..." 3 20 ; sleep 2
system="${1}"
romsdir=`cat /home/pi/RetroPie/retropiemenu/emulator.info |grep "${system};" |cut -f2 -d ";"`
fileext=`cat /home/pi/RetroPie/retropiemenu/emulator.info |grep "${system};" |cut -f3 -d ";"`
emus=`cat /home/pi/RetroPie/retropiemenu/emulator.info |grep "${system};" |cut -f4 -d ";"`
bios=`cat /home/pi/RetroPie/retropiemenu/emulator.info |grep "${system};" |cut -f5 -d ";"`
bioslocation=`cat /home/pi/RetroPie/retropiemenu/emulator.info |grep "${system};" |cut -f6 -d ";"`
...
infobox="${infobox}ROMS folder:   /home/pi/RetroPie/roms/${romsdir}\n\n"
