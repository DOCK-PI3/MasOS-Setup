...
function main_menu() {
    ...
    while true; do
        choice=$(dialog --backtitle "$BACKTITLE" --title " MAIN MENU " \
            ...
            --menu "Que accion te gustaria realizar?" 25 75 75 \
...
dialog --infobox " Actualizando script MasOS-Setup..." 30 75 ; sleep 5
cd 
	sudo rm -R MasOS-Setup/
		git clone --depth=1 https://github.com/DOCK-PI3/MasOS-Setup.git
	sudo chmod -R +x MasOS-Setup/
dialog --infobox " MasOS-Setup script se actualizo correctamente!..." 30 75 ; sleep 5
clear
done
}
