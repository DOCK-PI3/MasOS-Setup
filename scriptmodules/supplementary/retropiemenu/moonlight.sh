...
echo -e "\n****************************************************************"
echo -e "Welcome to the Moonlight Installer Script for MasOS BETA 1.0"
echo -e "****************************************************************\n"
...
case $NUM in
	1)
		...
		echo -e "\nPHASE SIX: Create STEAM Menu for MasOS"
		echo -e "*****************************************\n"
		...
		if grep -q "<platform>steam</platform>" /home/pi/.emulationstation/es_systems.cfg; then
			...
			sudo sed -i -e 's|</systemList>|  <system>\n    <name>steam</name>\n    <fullname>Steam</fullname>\n    <path>~/MasOS/roms/moonlight</path>\n    <extension>.sh .SH</extension>\n    <command>bash %ROM%</command>\n    <platform>steam</platform>\n    <theme>steam</theme>\n  </system>\n</systemList>|g' /home/pi/.emulationstation/es_systems.cfg
		fi
		echo -e "\n**** PHASE SIX Complete!!!! ****"

		echo -e "\nPHASE SEVEN: Create 1080p+720p Launch Scripts for MasOS"
		echo -e "**********************************************************\n"
		
		echo -e "Create Script Folder"
		mkdir -p /home/pi/MasOS/roms/moonlight
		cd /home/pi/MasOS/roms/moonlight
		
		echo -e "Create Scripts"
		if [ -f /home/pi/MasOS/roms/moonlight/720p30fps.sh ]; then
		...
		if [ -f /home/pi/MasOS/roms/moonlight/720p60fps.sh ]; then
		...
		if [ -f /home/pi/MasOS/roms/moonlight/1080p30fps.sh ]; then
		...
		if [ -f /home/pi/MasOS/roms/moonlight/1080p60fps.sh ]; then
		...
		chown -R pi:pi /home/pi/MasOS/roms/moonlight/
	...
	;;
	2)
		echo -e "\nCreate 1080p + 720p Launch Scripts for MasOS"
		echo -e "***********************************************\n"
	...
	;;
	4)  
		echo -e "\nCreate 480p Launch Scripts for MasOS"
		echo -e "*******************************************\n"
		...
		if [ -f /home/pi/MasOS/roms/moonlight/480p30fps.sh ]; then
		...
		if [ -f /home/pi/MasOS/roms/moonlight/480p60fps.sh ]; then
